...
";
  ...
  $stmt = mysqli_prepare($connection, $query);
  mysqli_stmt_bind_param($stmt, "sddsddsssdiiiisiiiiii", 
    $order['passenger'], 
    $order['from_latitude'], 
...
function passengerCancelOrderHard( $phone, $order_id, $reason_side ) {
  ...
  $query = "UPDATE orders set state='canceled', canceled_by_passenger=1 where id={$order_id} and passenger='{$phone}'"; 
  $result = mysqli_query($connection, $query);
...
function bombilaCancelOrderHard( $phone, $order_id, $reason_side ) {
  ...
  $query = sprintf("UPDATE orders set state='canceled', canceled_by_bombila=1 where id={$order_id} and bombila='{$phone}'"); 
  $result = mysqli_query($connection, $query);

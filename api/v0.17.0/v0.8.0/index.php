...
function registerUser($user) {
  ...
  try {
    ...
    $query = "INSERT INTO users(phone, firstname, lastname) VALUES(:phone, :firstname, :lastname)";
...
function getChatMessages( $phone1, $phone2 ) {
  ...
  $query = 
"SELECT 
  c.from_user,c.to_user,concat(u1.firstname,' ',u1.lastname) as 'from_fullname',c.message,c.number 
FROM chats as c 
...
function getCertificationPhotoState( $phone ) {
  ...
  $query = "SELECT state,reason from photocontrol where user=:phone and type='cert' limit 1";
...
function deleteCertificationPhoto( $phone ) {
  ...
  $query = "DELETE FROM photocontrol where user=:phone and type='cert'";
...
function getAutoPhotoState( $phone ) {
  ...
  $query = "SELECT state,reason from photocontrol where user=:phone and type='auto' limit 1";
...
function deleteAutoPhoto( $phone ) {
  ...
  $query = "DELETE FROM photocontrol where user=:phone and type='auto'"; 
...
function searchBombila( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set state='search_again' where id=:order_id and passenger=:phone"; 
...
function passengerCancelOrderSoft( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set state='canceled_before_accepted' where id=:order_id and passenger=:phone"; 
...
function acceptOrder( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set bombila=:phone, state='accepted' where id=:order_id"; 
...
function hereOrder( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set state='here' where id=:order_id and bombila=:phone"; 
...
function goOrder( $phone, $order_id, $waiting_price ) {
  ...
  $query = 
"INSERT INTO orders_sync(order_id, reason, state) VALUES(:order_id, :reason, :state)
";
...
function reachedOrder( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set state='reached' where id=:order_id and bombila=:phone"; 
...
function markOrderAsPaid( $phone, $order_id ) {
  ...
  $query = "UPDATE orders set state='paid' where id=:order_id and bombila=:phone"; 
...
function approveCertPhoto( $phone ) {
  ...
  $query = "UPDATE photocontrol set state='approved',reason='' where user=:phone and type='cert'"; 
...
function approveAutoPhoto( $phone ) {
  ...
  $query = "UPDATE photocontrol set state='approved',reason='' where user=:phone and type='auto'"; 
...
function declineCertPhoto( $phone, $reason ) {
  ...
  $query = "UPDATE photocontrol set state='not_approved',reason=:reason where user=:phone and type='cert'"; 
...
function declineAutoPhoto( $phone, $reason ) {
  ...
  $query = "UPDATE photocontrol set state='not_approved',reason=:reason where user=:phone and type='auto'"; 
...
(
  ...
  if( $to_user != 'dispatcher' ) {
    ...
    sendPushNotification( $to_user, 'chat_message', $message );
  }
...
function requestPassengerRoute( $phone, $order_id ) {
  ...
  $query = 
"INSERT INTO orders_sync(order_id, reason, state) 
select :order_id as order_id, :reason as reason, :state as state
from orders
